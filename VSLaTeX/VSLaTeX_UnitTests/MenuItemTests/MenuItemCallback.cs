...
using Informagic.VSLaTeX;

namespace VSLaTeX_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSLaTeXPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Informagic.VSLaTeX.GuidList.guidVSLaTeXCmdSet, (int)Informagic.VSLaTeX.PkgCmdIDList.cmdidLatex);
