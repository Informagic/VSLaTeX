...
namespace VSLaTeX_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Informagic.VSLaTeX.GuidList.guidVSLaTeXCmdSet, (int)Informagic.VSLaTeX.PkgCmdIDList.cmdidLatex);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VSLaTeX", "Informagic.VSLaTeX.VSLaTeXPackage");
